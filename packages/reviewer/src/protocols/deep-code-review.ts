...
2. Establish scope. Inspect the selected diff and changed-file list before exploring surrounding code.
...
7. Use history selectively. Inspect blame or prior changes when intent is unclear or when the patch changes an established invariant. Do not browse history ceremonially.
