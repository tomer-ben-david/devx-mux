...
if (
  ...
  console.error("Usage: chatgpt-review-poll.mjs <cmux|rex> <surface-or-pane> <REQUEST_ID|TURN_TOKEN>");
  process.exit(2);
}

const selectedTool = tool as "cmux" | "rex";
const boundary = bindBrowserReviewBoundary(selectedTool, target, parseReviewBoundary(boundaryValue));
